        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-align-justify"></i> Список статусов
                    <a href="{{route('status.create')}}" class="float-right">Добавить</a>
                </div>
                <div class="card-block">
                    ...
                    @include('admin.layouts.pagination', ['pagination' => $statuses])
                </div>
            </div>
        </div>
        <!--/.col-->
